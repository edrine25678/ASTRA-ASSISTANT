...
def main():
    ...
    from ui.state import ALL_STATES, ERROR, IDLE, LISTENING, SPEAKING, THINKING, UiState
    ...
    ok(wait_until(lambda: any("Astra heard: open chrome" in s for s in speaker.spoken), 5),
